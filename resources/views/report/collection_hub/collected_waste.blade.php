...
<div class="container">
    <div class="row justify-content-center">
        <div class="col">
            <div class="card">
                <div class="card-header">Collection Hub - Collected Waste</div>
                <div class="card-body">
                    ...
                    <canvas id="chartTotalCollectedWaste" width="300"></canvas>
                    <br>
                    <br>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function showData() {
        ...
        jQuery.ajax({
            url: '{{ route("report.collectionhub_collected_waste_data") }}',
            method: 'post',
            data: {
                "_token": "{{ csrf_token() }}",
                format: format,
            ...
            success: function(data) {
                ...
                var ctx = document.getElementById('chartTotalCollectedWaste');
