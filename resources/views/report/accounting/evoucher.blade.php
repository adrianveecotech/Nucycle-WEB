  ...
  <div class="card">
    ...
    <div class="card-body">
        <div class="text-right pb-2">
          <form method="post" action="{{route('report.accounting.evoucher_filter')}}">
            @csrf
            ...
            <a href="{!! route('report.accounting.evoucher') !!}" id="btn_csv" class="btn btn-xs btn-success ml-2">Reset</a>
        </div>
