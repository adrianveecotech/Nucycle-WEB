            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-form-label">
                            {!!optional($schedule->collection_hub)->hub_name !!}
                        </div>
                    </div>
                    
                    <div class="form-group row">
                        <label for="hub" class="col-md-4 col-form-label text-md-right">{{ __('Collection Hub Address') }}</label>
                        <div class="col-md-6 col-form-label">
                            {!!optional($schedule->collection_hub)->hub_address !!} , {!!optional($schedule->collection_hub)->hub_postcode !!} , {!!optional(optional($schedule->collection_hub)->city)->name !!} , {!!optional(optional($schedule->collection_hub)->state)->name !!}
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="hub" class="col-md-4 col-form-label text-md-right">{{ __('Collection Hub Operating Hours') }}</label>
                        <div class="col-md-6 col-form-label">
                            {!!optional($schedule->collection_hub)->operating_day !!}, {!!optional($schedule->collection_hub)-> operating_hours !!}
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="hub" class="col-md-4 col-form-label text-md-right">{{ __('Collection Hub Contact Number') }}</label>
                        <div class="col-md-6 col-form-label">
                            {!!optional($schedule->collection_hub)->contact_number !!}
                        </div>
                    </div>
