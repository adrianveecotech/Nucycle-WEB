...
<div class="row ">
        <div class="col">
            <div class="card">
                <div class="card-header">{{ __('Add New Collection Hub Collector') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('collection_hub_collector.insert_db') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" value="{{old('email')}}" type="email" class="form-control @error('email') is-invalid @enderror" name="email" autofocus>
