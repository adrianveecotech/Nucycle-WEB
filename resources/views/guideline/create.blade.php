...
<div class="container">
    <div class="row ">
        <div class="col">
            <div class="card">
                <div class="card-header">{{ __('Add New Guideline') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('guideline.insert_db') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="start_date" type="datetime-local" value="{{ old('start_date') }}" class="form-control @error('start_date') is-invalid @enderror" name="start_date">
                                @error('start_date')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="end_date" type="datetime-local" value="{{ old('end_date') }}" class="form-control @error('end_date') is-invalid @enderror" name="end_date">
                                @error('end_date')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="checkbox" id="for_customer" name="for_customer" value="2">
                                <label for="for_customer">User</label><br>
                                <input type="checkbox" id="for_collector" name="for_collector" value="3">
