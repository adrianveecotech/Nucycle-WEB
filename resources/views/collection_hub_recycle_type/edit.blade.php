...
<div class="container">
    <div class="row ">        <div class="col">
            <form method="POST" action="{{ route('collection_hub_recycle_type.edit_db') }}">
                <!-- <form method="POST"> -->
                @csrf
                <div class="card">
                    <div class="card-header">{{ __('Edit Collection Hub Recycle Type ') }}</div>
                    <div class="card-body">
                        <div id="body">
                            ...
                            <div id="dynamicInput[<?php echo $key ?>]">
                                <input type="hidden" name="id" value="{{$hub_recycle->recycle_type_id}}">
                                <input type="hidden" name="hub_id" value="{{$hub_recycle->collection_hub_id}}">
                                <input type="hidden" name="index[]" value="{{$hub_recycle->id}}">
                                <div class="form-group row mt-5">
                                    <label for="point" class="col-md-4 col-form-label text-md-right">{{ __('Point') }}</label>

                                    <div class="col-md-6">
                                        <input type="text" value="{{$hub_recycle->point}}" class="form-control @error('point') is-invalid @enderror" name="point[]">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="datetime-local" value="<?php echo date('Y-m-d\TH:i', strtotime($hub_recycle->start_date)); ?>" class="form-control @error('start_date') is-invalid @enderror" name="start_date[]">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="datetime-local" value="<?php echo date('Y-m-d\TH:i', strtotime($hub_recycle->end_date)); ?>" class="form-control @error('end_date') is-invalid @enderror" name="end_date[]">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        @if($hub_recycle->is_active == 1)
                                        <input type="checkbox" name="active_status[]" value="{{$hub_recycle->id}}" checked>
                                        @elseif($hub_recycle->is_active == 0)
                                        <input type="checkbox" name="active_status[]" value="{{$hub_recycle->id}}">
                                        @endif
